...
describe('Frontpage', function() {
  ...
  it('renders front page correctly', function () {
    ...
    withRenderedTemplate('Frontpage', data, el => {
      expect($(el).context.innerText).to.include("Rapid rule out of myocardial infarction")
      expect($(el).context.innerHTML).to.include("This protocol is for patients with chest pain and suspected acute myocardial infarction")
